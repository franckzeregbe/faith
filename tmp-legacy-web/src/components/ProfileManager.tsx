...
import { loadJsonFromStorage, saveJsonToStorage, STORAGE_KEYS } from '../utils/storage'
  ...
  return (
    <div>
      ...
      <div className="form-row" style={{ marginTop: 10 }}>
        <input placeholder="Slogan (ex: « Jésus revient bientôt »)" value={profile.slogan} onChange={e => setProfile({ ...profile, slogan: e.target.value })} />
      </div>
