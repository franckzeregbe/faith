...
import { convertEntrySchema } from '../schemas'
...
export default function ConvertManager() {
  ...
  useEffect(() => {
    const result = loadValidatedList(STORAGE_KEYS.converts, convertEntrySchema)
    setEntries(result.data)
  }, [])

  useEffect(() => {
    const result = saveValidatedList(STORAGE_KEYS.converts, convertEntrySchema, entries)
